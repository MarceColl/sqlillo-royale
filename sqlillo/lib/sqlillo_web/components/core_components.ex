defmodule SqlilloWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(SqlilloWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(SqlilloWeb.Gettext, "errors", msg, opts)
    # end
